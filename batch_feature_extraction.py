...
dataset_name = 'resim'  # Datasets: ansim, resim, cansim, cresim, real, mansim and mreal
...
for ovo in [1]:  # SE overlap. Change to [1] if you are only calculating the features for overlap 1.
    for splito in [2, 3]:    # all splits. Use [1, 8, 9] for 'real' and 'mreal' datasets. Change to [1] if you are only calculating features for split 1.
